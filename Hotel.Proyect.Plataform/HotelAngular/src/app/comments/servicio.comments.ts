...
export class CommentsServicio {
    private _getListarCommentsURL = 'http://localhost:55349/api/comments/ListarComments';
    private _registrarCommentsURL : string = 'http://localhost:55349/api/comments/IngresarComments'
...
comments : Comments[];
    ...
    GetComments() : Observable<Comments[]>{
        ...
        .pipe(map((response: Response) => <Comments[]> response.json()),
        catchError(error => {
